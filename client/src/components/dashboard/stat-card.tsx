    ...
    <div className="bg-white rounded-xl shadow-card p-5 border border-neutral-200 transition-shadow hover:shadow-card-hover">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-2xl font-mono font-semibold mt-1">{formattedValue}</p>
        </div>
      ...
      {change !== undefined && (
        <div className="flex items-center mt-3">
          ...
          {period && <span className="text-neutral-500 text-sm ml-2">{period}</span>}
        </div>
      )}
      ...
      {progress !== undefined && (
        <div className="mt-3">
          ...
          {nextMilestone && (
            <p className="text-neutral-500 text-sm mt-1">{nextMilestone}</p>
          )}
        </div>
      )}
    </div>
